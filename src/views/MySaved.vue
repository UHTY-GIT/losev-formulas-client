<template>
  ...
  <div class="all-podcast-block">
    <div v-if="podcasts.length === 0" class="no-podcasts-message">
      <p>
        Тут відображатимуться збережені подкасти.<br>
        Додайте до улюбленого свій перший подкаст щоб побачити його тут.
      </p>
    </div>
...
export default {
  ...
  methods: {
    ...
    // // СТРАРИЙ Метод для анімації кнопки лайку на блоці постів
  ...
  async created() {
    ...
    // отримання даних всіх улюблених подкастів
