<!--scr/components/Main/AllRecommendationsPodcasts.vue-->
<template>
  <div class="view_all">
    <p>
      <router-link to="/">Головна</router-link> > <router-link to="/all-recommendation-podcasts">Рекомендації</router-link>
    </p>
  </div>
