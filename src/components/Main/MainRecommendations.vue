<!--scr/components/Main/MainRecommendationsPodcasts.vue-->
<template>
  <div class="Categories_main">
    <p>Рекомендації</p>
    <router-link to="/all-recommendation-podcasts">
      Показати всі
    </router-link>
  </div>
  ...
  <div v-else class="block_content_podcast">
    <div
        v-for="podcast in recommendationPodcasts"
        :key="podcast.id"
